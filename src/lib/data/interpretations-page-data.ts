...
export const PLANETS_DATA: PlanetData[] = [
  {
    ...
    symbol: '☉',
    element: 'Fire',
    description: 'The Sun represents your core identity, conscious will, and life direction, showing how you express yourself and pursue purpose.',
  ...
  },
  {
    ...
    symbol: '☽',
    element: 'Water',
    description: 'The Moon reflects your emotional world, instincts, and need for safety, shaping how you process feelings and seek comfort.',
  ...
  },
  {
    ...
    symbol: '☿',
    element: 'Air',
    description: 'Mercury describes how you think, speak, and learn, including your communication style, curiosity, and everyday mental patterns.',
  ...
  },
  {
    ...
    symbol: '♀',
    element: 'Earth',
    description: 'Venus shows how you relate, what you value, and what you find beautiful, guiding love, pleasure, and artistic taste.',
  ...
  },
  {
    ...
    symbol: '♂',
    element: 'Fire',
    description: 'Mars represents your drive, courage, and assertive energy, revealing how you take action, handle conflict, and pursue desire.',
  ...
  },
  {
    ...
    symbol: '♃',
    element: 'Fire',
    description: 'Jupiter governs growth, faith, and meaning, highlighting where you expand through learning, opportunity, and optimism.',
  ...
  },
  {
    ...
    symbol: '♄',
    element: 'Earth',
    description: 'Saturn represents responsibility, structure, and long-term mastery, marking the areas where effort and maturity are required.',
  ...
  },
  {
    ...
    symbol: '♅',
    element: 'Air',
    description: 'Uranus signifies disruption, freedom, and innovation, showing where you break patterns and express originality.',
  ...
  },
  {
    ...
    symbol: '♆',
    element: 'Water',
    description: 'Neptune rules imagination, spirituality, and dissolving boundaries, inspiring compassion while blurring certainty.',
  ...
  },
  {
    ...
    symbol: '♇',
    element: 'Water',
    description: 'Pluto represents deep transformation and power dynamics, revealing where you confront intensity, release control, and regenerate.',
...
export const SIGNS_DATA: SignData[] = [
  {
    ...
    quality: 'Cardinal',
    ruler: 'Mars',
    description: 'Aries is bold, direct, and action-oriented, initiating change with courage, speed, and competitive fire.',
  ...
  },
  {
    ...
    quality: 'Fixed',
    ruler: 'Venus',
    description: 'Taurus is grounded, steady, and sensual, focused on building security, comfort, and lasting value.',
  ...
  },
  {
    ...
    quality: 'Mutable',
    ruler: 'Mercury',
    description: 'Gemini is curious and mentally agile, thriving on conversation, variety, and constant learning.',
  ...
  },
  {
    ...
    quality: 'Cardinal',
    ruler: 'Moon',
    description: 'Cancer is emotionally attuned and protective, prioritizing care, belonging, and strong roots.',
  ...
  },
  {
    ...
    quality: 'Fixed',
    ruler: 'Sun',
    description: 'Leo expresses confidence, creativity, and heart-led leadership, seeking to shine and inspire.',
  ...
  },
  {
    ...
    quality: 'Mutable',
    ruler: 'Mercury',
    description: 'Virgo is precise and service-minded, bringing discernment, practical skill, and continuous refinement.',
  ...
  },
  {
    ...
    quality: 'Cardinal',
    ruler: 'Venus',
    description: 'Libra seeks harmony, fairness, and mutual understanding, excelling at partnership and diplomacy.',
  ...
  },
  {
    ...
    quality: 'Fixed',
    ruler: 'Pluto',
    description: 'Scorpio is intense and transformative, drawn to emotional truth, depth, and psychological insight.',
  ...
  },
  {
    ...
    quality: 'Mutable',
    ruler: 'Jupiter',
    description: 'Sagittarius is adventurous and truth-seeking, pursuing growth through exploration, philosophy, and perspective.',
  ...
  },
  {
    ...
    quality: 'Cardinal',
    ruler: 'Saturn',
    description: 'Capricorn is disciplined and strategic, focused on long-term achievement, responsibility, and steady progress.',
  ...
  },
  {
    ...
    quality: 'Fixed',
    ruler: 'Uranus',
    description: 'Aquarius is independent and future-focused, valuing innovation, social progress, and unconventional thinking.',
  ...
  },
  {
    ...
    quality: 'Mutable',
    ruler: 'Neptune',
    description: 'Pisces is empathetic and imaginative, blending intuition and sensitivity with a strong spiritual current.',
